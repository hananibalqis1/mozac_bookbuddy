<?php
    ...
    if($result !== false && $result->num_rows > 0) {
        ...
        echo "<table>";
        echo "<tr><th>ISBN</th><th>Book Cover</th><th>Book Details</th><th colspan='2'>Edit Book</th></tr>";
        ...
        ?>
            <td>
                <a href="updateLib.php?isbn=<?php echo $row['isbn'] ?>"><input type="button" value="Edit"/></a>
        </td>
        <td>
