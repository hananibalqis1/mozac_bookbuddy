<?php
    ...
    if($result !== false && $result->num_rows > 0) {
        ...
        <form action='search-lib.php' method='post'><input type='search' name='search' placeholder='Search here..'>&nbsp;<input type ='submit'></form><br>";
        echo "<table>";
        // echo "<tr><th>ISBN</th><th>Book Cover</th><th>Book Details</th><th>Action</th></tr>";
        echo "<tr><th>ISBN</th><th>Book Details</th><th colspan='2'>Action</th></tr>";
        ...
        ?>
            <td>
                <!-- PERLU PASTIKAN VIEW DETAILS KE MANA -->
                <a href="displayBook.php?isbn=<?php echo $row['isbn'] ?>"><input type="button" value="View Details"/></a>
            </td>
            <td>
                <a href="issued-history.php?isbn=<?php echo $row['isbn'] ?>"><input type="button" value="History"/></a>
            </td>
        <?php
        }
